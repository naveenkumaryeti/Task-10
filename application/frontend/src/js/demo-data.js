...
const DEMO_PRODUCTS = [
  ...
  { id: 6, category_id: 1, name: "Coriander Leaves", weight: "100 g", price: 12, mrp: 15, stock: 90, image_url: img("coriander") },
  ...
  { id: 12, category_id: 2, name: "Corn Flakes", weight: "375 g", price: 149, mrp: 175, stock: 55, image_url: img("cornflakes") },

  // Munchies
  { id: 13, category_id: 3, name: "Potato Chips Classic", weight: "52 g", price: 20, mrp: 20, stock: 200, image_url: img("chips1") },
  ...
  { id: 22, category_id: 5, name: "Digestive Biscuits", weight: "250 g", price: 45, mrp: 50, stock: 120, image_url: img("digestive") },
  ...
  { id: 26, category_id: 6, name: "Veg Frozen Momos", weight: "250 g", price: 129, mrp: 149, stock: 55, image_url: img("momos") },
  { id: 27, category_id: 6, name: "Frozen Pizza Base", weight: "2 pcs", price: 79, mrp: 89, stock: 45, image_url: img("pizzabase") },
  ...
  { id: 30, category_id: 7, name: "Health Drink Malt", weight: "500 g", price: 210, mrp: 240, stock: 50, image_url: img("healthdrink") },

  // Atta, Rice & Dal
  { id: 31, category_id: 8, name: "Wheat Atta", weight: "5 kg", price: 220, mrp: 250, stock: 80, image_url: img("atta") },
  { id: 32, category_id: 8, name: "Basmati Rice", weight: "5 kg", price: 399, mrp: 450, stock: 60, image_url: img("rice") },
  { id: 33, category_id: 8, name: "Toor Dal", weight: "1 kg", price: 145, mrp: 160, stock: 90, image_url: img("dal") },
  ...
  { id: 36, category_id: 9, name: "Red Chilli Powder", weight: "200 g", price: 55, mrp: 60, stock: 110, image_url: img("chilli") },

  // Sweet Tooth
  { id: 37, category_id: 10, name: "Dark Chocolate Bar", weight: "80 g", price: 99, mrp: 110, stock: 100, image_url: img("chocolate") },
  { id: 38, category_id: 10, name: "Gulab Jamun Tin", weight: "1 kg", price: 175, mrp: 199, stock: 40, image_url: img("gulabjamun") },
  { id: 39, category_id: 10, name: "Ice Cream Tub", weight: "700 ml", price: 210, mrp: 240, stock: 35, image_url: img("icecream") },

  // Personal Care
  { id: 40, category_id: 11, name: "Face Wash", weight: "100 ml", price: 149, mrp: 175, stock: 70, image_url: img("facewash") },
  ...
  // Home & Cleaning
  { id: 43, category_id: 12, name: "Dishwash Liquid", weight: "500 ml", price: 99, mrp: 110, stock: 90, image_url: img("dishwash") },
  { id: 44, category_id: 12, name: "Floor Cleaner", weight: "1 L", price: 125, mrp: 140, stock: 75, image_url: img("floorcleaner") },
